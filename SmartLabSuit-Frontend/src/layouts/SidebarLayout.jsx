...
function Sidebar({ isOpen, toggleSidebar, role }) {
  ...
  return (
    <div className={`h-full bg-blue-900 text-white flex flex-col ${isOpen ? 'w-64' : 'w-20'} transition-all duration-300`}> <div className="flex items-center justify-between p-4 sticky top-0 bg-blue-900 z-10"> <span className="text-xl font-bold">{isOpen ? 'Research Center' : 'RC'}</span> <button onClick={toggleSidebar} className="text-white focus:outline-none">
      ☰ </button> </div>
